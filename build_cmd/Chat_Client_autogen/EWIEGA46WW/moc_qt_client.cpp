...
QT_MOC_LITERAL(4, 33, 11), // "loginResult"
QT_MOC_LITERAL(5, 45, 2), // "ok"
QT_MOC_LITERAL(6, 48, 3), // "msg"
QT_MOC_LITERAL(7, 52, 14), // "registerResult"
QT_MOC_LITERAL(8, 67, 11), // "onReadyRead"
QT_MOC_LITERAL(9, 79, 11), // "onConnected"
QT_MOC_LITERAL(10, 91, 14), // "onDisconnected"
QT_MOC_LITERAL(11, 106, 7), // "onError"
QT_MOC_LITERAL(12, 114, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(13, 143, 5), // "error"
QT_MOC_LITERAL(14, 149, 13) // "sendHeartbeat"

    },
    "QtClient\0connected\0\0disconnected\0"
    "loginResult\0ok\0msg\0registerResult\0"
    "onReadyRead\0onConnected\0onDisconnected\0"
    "onError\0QAbstractSocket::SocketError\0"
    "error\0sendHeartbeat"
};
...
void QtClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->loginResult((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtClient::connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QtClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtClient::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QtClient::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtClient::loginResult)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QtClient::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtClient::registerResult)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void QtClient::loginResult(bool _t1, const QString & _t2)
{
...
// SIGNAL 3
void QtClient::registerResult(bool _t1, const QString & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
